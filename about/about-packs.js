...
window.ABOUT_PACKS = {
  overview: {
    ...
    startsWith:'o_intro',
    nodes:{
      o_intro:{ speaker:'Archivist', text:'Welcome to 420360. A marijuana-first synthesis of retro arcade nostalgia, glitch aesthetics, and contemplative smoke-circle dialogue. What lens do you want?', choices:[ { text:'Mission', to:'o_mission' }, { text:'Philosophy', to:'o_philo' }, { text:'Feature Map', to:'o_features' } ] },
      o_mission:{ speaker:'Archivist', text:'MISSION: Curate playful cannabis-themed experiments that rekindle curiosity, calm, and contemplative drift. Output > Hype.', choices:[ { text:'Return', to:'o_intro' }, { text:'Philosophy', to:'o_philo' }, { text:'End', to:'o_end' } ] },
      ...
      o_features:{ speaker:'Archivist', text:'FEATURE MAP:\n• Weed-friendly mini-games (arcade classics reimagined)\n• Procedural art smoke-spaces\n• Narrative oracles and trip journals\n• Ambient audio / haze-glitch layers', choices:[ { text:'Philosophy', to:'o_philo' }, { text:'Mission', to:'o_mission' }, { text:'End', to:'o_end' } ] },
  ...
  content: {
    ...
    startsWith:'c_intro',
    nodes:{
      c_intro:{ speaker:'Archivist', text:'Content spans INTERACTIVE (games), GENERATIVE (art), and REFLECTIVE (dialogue), all tuned for cannabis culture. What angle?', choices:[ { text:'Interactive', to:'c_interactive' }, { text:'Generative', to:'c_generative' }, { text:'Reflective', to:'c_reflective' } ] },
      c_interactive:{ speaker:'Archivist', text:'INTERACTIVE: Classic mechanics re-skinned for a stoner-arcade tempo. Accessible skill ramps, soft pressure loops, and playful pacing.', choices:[ { text:'Generative', to:'c_generative' }, { text:'Reflective', to:'c_reflective' }, { text:'End', to:'c_end' } ] },
      c_generative:{ speaker:'Archivist', text:'GENERATIVE: Algorithmic visuals and emergent palettes inspired by smoke trails, neon resin, and late-night lounge drift.', choices:[ { text:'Interactive', to:'c_interactive' }, { text:'Reflective', to:'c_reflective' }, { text:'End', to:'c_end' } ] },
      c_reflective:{ speaker:'Archivist', text:'REFLECTIVE: Dialogue oracles and ambient lore produce contemplative loops for adults, not fixed canon or medical guidance.', choices:[ { text:'Interactive', to:'c_interactive' }, { text:'Generative', to:'c_generative' }, { text:'End', to:'c_end' } ] },
  ...
  roadmap: {
    ...
    nodes:{
      ...
      r_short:{ speaker:'Archivist', text:'SHORT: More cannabis-lore dialogue packs, accessibility polish, lounge audio layers, and scoring refinement.', choices:[ { text:'Mid Term', to:'r_mid' }, { text:'Long Term', to:'r_long' }, { text:'End', to:'r_end' } ] },
      r_mid:{ speaker:'Archivist', text:'MID: Community smoke-session events, procedural quest loops, adaptive strain-inspired theming.', choices:[ { text:'Short Term', to:'r_short' }, { text:'Long Term', to:'r_long' }, { text:'End', to:'r_end' } ] },
  ...
  meta: {
    ...
    startsWith:'m_intro',
    nodes:{
      m_intro:{ speaker:'Archivist', text:'Choose a curiosity vector.', choices:[ { text:'Monetization', to:'m_money' }, { text:'Data & Privacy', to:'m_priv' }, { text:'Why Cannabis Retro', to:'m_retro' } ] },
      m_money:{ speaker:'Archivist', text:'MONETIZATION: Minimal. Focus on creative practice continuity over ad saturation.', choices:[ { text:'Privacy', to:'m_priv' }, { text:'Why Cannabis Retro', to:'m_retro' }, { text:'End', to:'m_end' } ] },
      m_priv:{ speaker:'Archivist', text:'PRIVACY: Prefer static assets; light or no tracking by design (context-dependent).', choices:[ { text:'Monetization', to:'m_money' }, { text:'Why Cannabis Retro', to:'m_retro' }, { text:'End', to:'m_end' } ] },
      m_retro:{ speaker:'Archivist', text:'CANNABIS RETRO: Temporal distance plus cannabis culture creates a slower, more intentional aesthetic that invites playful experimentation.', choices:[ { text:'Monetization', to:'m_money' }, { text:'Privacy', to:'m_priv' }, { text:'End', to:'m_end' } ] },
