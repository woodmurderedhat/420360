...
export function drawLightRaysLayer(ctx, palette, isAnimationFrame, params, opacity = 1.0) {
    ...
    // Parse the color to create the gradient
    const r = parseInt(rayColor.slice(1, 3), 16);
    const g = parseInt(rayColor.slice(3, 5), 16);
    const b = parseInt(rayColor.slice(5, 7), 16);
